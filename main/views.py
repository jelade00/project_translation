...
def merge_segments_into_sentences(segments, max_words=50, max_duration=12.0):
    """
...
def process_video_task(task_id, tmp_path, original_filename):
    ...
    try:
        ...
        # 5. Объединение фрагментов в осмысленные предложения
        ...
        # 7. Формирование вывода (HTML, plain, subtitles)
        t = time.time()
        output_lines_html = []
        output_lines_plain = []
        subtitles = []
